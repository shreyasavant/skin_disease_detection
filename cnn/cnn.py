...
def main():
    ...
    parser.add_argument(
        "--model_out", default="models/cnn_v" + timestamp_str + ".keras"
    )
    args = parser.parse_args()

    print("\n===> Loading datasets")
    train_ds, val_ds, test_ds, class_names = bin.data.make_datasets(
    ...
    bin.train.train_model(
        model, base_model, train_ds, val_ds, args.epochs, args.model_out
    )
